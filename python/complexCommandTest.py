...
if __clientID!=-1:
    ...
    emptyBuff = bytearray()
    res,retInts,retFloats,retStrings,retBuffer=vrep.simxCallScriptFunction(__clientID, 'remoteApiCommandServer', vrep.sim_scripttype_childscript, 'displayText_function', [], [], ['Hello world!'], emptyBuff, vrep.simx_opmode_blocking)
    ...
    res,retInts,retFloats,retStrings,retBuffer=vrep.simxCallScriptFunction(__clientID, 'remoteApiCommandServer', vrep.sim_scripttype_childscript, 'createDummy_function', [], [0.1, 0.2, 0.3], ['MyDummyName'], emptyBuff, vrep.simx_opmode_blocking)
    if res==vrep.simx_return_ok:
    ...
    "return 'done'"
    res,retInts,retFloats,retStrings,retBuffer=vrep.simxCallScriptFunction(__clientID, "remoteApiCommandServer", vrep.sim_scripttype_childscript, 'executeCode_function', [], [], [code], emptyBuff, vrep.simx_opmode_blocking)
    if res==vrep.simx_return_ok:
